<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold"><i class="bi bi-plus-circle"></i> Thêm chi phí</h2>
        <a href="<?= BASE_URL ?>?action=costs/index&tour_id=<?= $tour['id'] ?>" class="btn btn-secondary">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Thêm chi phí
                            </button>
                        </div>
                    </form>
                </div>
